...
extern "C" int   is_symmetric(void *network);
extern "C" int   input_max(void *network, unsigned int index);
extern "C" int   input_min(void *network, unsigned int index);
extern "C" int   input_mean(void *network, unsigned int index);
extern "C" int   input_range(void *network, unsigned int index);
extern "C" int   output_mean(void *network);
extern "C" int   output_range(void *network);
