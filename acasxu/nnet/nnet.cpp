...
int is_symmetric(void *network)
{
    ...
    NNet *nnet = static_cast<NNet *>(network);
    return nnet->symmetric;
}


int input_max(void *network, unsigned int index)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    assert(index < nnet->inputSize);
    return nnet->maxes[index];
}


int input_min(void *network, unsigned int index)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    assert(index < nnet->inputSize);
    return nnet->mins[index];
}


int input_mean(void *network, unsigned int index)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    assert(index < nnet->inputSize);
    return nnet->means[index];
}


int input_range(void *network, unsigned int index)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    assert(index < nnet->inputSize);
    return nnet->ranges[index];
}


int output_mean(void *network)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    return nnet->means[nnet->inputSize];
}

int output_range(void *network)
{
    if (network ==NULL)
    {
        printf("Data is Null!\n");
    ...
    NNet *nnet = static_cast<NNet *>(network);
    return nnet->ranges[nnet->inputSize];
}
